...
public class DevourerHeadRenderer extends MobRenderer<DevourerEntity, TerrariaLivingEntityRenderState, DevourerModel<TerrariaLivingEntityRenderState>> {
    ...
    public DevourerHeadRenderer(EntityRendererProvider.Context context) {
        super(context, new DevourerModel<>(context.bakeLayer(ModModelLayers.DEVOURER_HEAD)), 0.40F);
    }
