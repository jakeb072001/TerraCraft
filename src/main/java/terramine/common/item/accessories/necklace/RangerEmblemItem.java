...
public class RangerEmblemItem extends AccessoryTerrariaItem {

	public RangerEmblemItem(ResourceKey<Item> key) {
		super(key);
	}
	...
	protected Multimap<Holder<Attribute>, AttributeModifier> applyModifiers(ItemStack stack, LivingEntity entity, UUID uuid) {
		...
		AttributeModifier modifier = new AttributeModifier(TerraMine.id("ranger_emblem_attack_damage"), 0.15f, AttributeModifier.Operation.ADD_MULTIPLIED_TOTAL);
